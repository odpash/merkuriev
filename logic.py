        ...
        for i in dbase:
            if i[9] is None:
                ...
                try:
                    ...
                    photo = InputFile(f"database/{i[0]}.pdf")
                    m_id.append(await bot.send_document(chat_id=message.chat.id, document=photo, caption=text,
                                                     reply_markup=approve_btn(i[0])))
        return m_id
    except:
        pass
